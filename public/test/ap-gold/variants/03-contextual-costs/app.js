// 03-contextual-costs app.js — Decision-point variant
(function() {
  'use strict';

  const markersData = [
    { id: 'store', label: 'Store', x: 20, y: 80, visited: false, costTag: 'gold accepted' },
    { id: 'portal', label: 'Enter The Portal', x: 50, y: 80, visited: false, costTag: '10 AP · 50gc' },
